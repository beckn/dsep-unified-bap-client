...
class MentorDTO {
    static toMentorSearchRequest(data) {
        return {
    ...
    static toMentorInitRequest(data) {
        return {
    ...
    static toMentorSelectRequest(data) {
        return {
    ...
    static toMentorConfirmRequest(data) {
        return {
    ...
    static toMentorSearchResponse(data) {
        return {
            context: {
                domain: data.context.domain,
                country: data.context.country,
    ...
    static toMentorInitResponse(data) {
        return {
    ...
    static toMentorSelectResponse(data) {
        return {
